...
namespace YazilimMimarisi
{
    public partial class FrmHastaKayit : Form
    {
        ...
        private Hasta hastaNesnesiDoldur(Hasta hasta) 
        {
            ...
            IHastalikTipi hastalik = fabrika.HastalikNesnesiOlustur(cmbHastalik.Text);
            IDiyetTipi diyet = fabrika.DiyetNesnesiOlustur(cmbDietTipi.Text);
        ...
        // Kapatma ve geri gelme butonları
